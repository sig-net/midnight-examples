...
/**
 * Poll the signet contract's notification registry (read the way the MPC
 * reads it — raw state by field position) until an entry for `requestId`
 * appears and decodes, or `timeoutMs` (default 60s) passes.
 *
