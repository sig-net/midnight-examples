...
// The vault has 23 ledger fields, past the 15-field flat limit, so the compiler
...
// requestsPathDepth 2. Chunk 0 holds fields 0–7, chunk 1 holds fields 8–22.
...
/**
 * Resolved ledger-tree path of `depositEventMap` (ledger field 11). Deposits
...
/**
 * Resolved ledger-tree path of `swapEventMap` (ledger field 15). Swaps register
...
/** Resolved ledger-tree path of `supplyEventMap` (ledger field 19). */
export const VAULT_SUPPLY_REQUESTS_PATH: readonly number[] = [1, 11];

/** Resolved ledger-tree path of `redeemEventMap` (ledger field 21). */
