...
// request counter at field 3. A client contract is free to place its event
// map at any field: every raw reader takes the position explicitly, and the
...
export const VAULT_NONCE_FIELD = 3;
