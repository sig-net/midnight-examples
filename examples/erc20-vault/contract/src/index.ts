...
// erc20-vault.compact): the SignBidirectionalEventMap at field 0, the request
// counter at field 1. A client contract is free to place its event map at any
// field: every raw reader takes the position explicitly, and the position
// must match the `0 as Uint<8>` requestsIndexField the contract passes in its
// notifications.
