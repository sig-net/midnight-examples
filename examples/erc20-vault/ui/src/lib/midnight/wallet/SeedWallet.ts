 ...
 */
function initialiseWalletFacade(keys: AccountKeys, config: MidnightNodeConfig): Promise<WalletFacade> {
...
export class SeedWallet implements Wallet {
    ...
    /** The wallet's shielded coin public key, as the ledger's hex string. */
    getCoinPublicKey(): ledger.CoinPublicKey {
        return this.requireInitialised().keys.shieldedSecretKeys.coinPublicKey;
    }

    /** The wallet's shielded encryption public key, as the ledger's hex string. */
