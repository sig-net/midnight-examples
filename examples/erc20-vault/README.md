...
import { pureCircuits, VAULT_REQUESTS_PATH } from "@sig-net/midnight-examples-erc20-vault-contract";
...
| `@sig-net/midnight-examples-erc20-vault-deploy` | [`deploy/`](deploy/) | The deploy and initialize flows |
