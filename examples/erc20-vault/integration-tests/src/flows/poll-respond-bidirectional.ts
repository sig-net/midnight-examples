 ...
 * in-circuit, which is the actual authentication gate. This flow owns the
 * poll loop, the timeout, and the reporting: it logs the outcome (success
 * flag / MPC failure output), and acting on it (claiming, refunding) is the
 * caller's job.
 *
